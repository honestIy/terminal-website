var Terminal = Terminal || function(cmdRequest, cmdResponse) {
  ...
  const CMDS_ = [
    'i', 'a', 'clear', 'date', 'tellmesomething', 'whoami', 'whoareyou', 'iloveyou'
  ];
    ...
    if (e.keyCode == 9) {
      ...
      switch (cmd) {
        case 'ls':
          ...
          break;
        case 'socials':
              output("choose a number <br><br>[1] instagram <br>[2] twitter <br>[3] tryhackme");
        break;     
          case '1':
          window.open("https://instagram.com/r9inz", "_blank");                    
          break;
          case '2':
          window.open("https://twitter.com/deepIyscared", "_blank");                    
          break;
          case '3':
          window.open("https://tryhackme.com/p/r9in", "_blank");                    
          break;
        case 'play':
